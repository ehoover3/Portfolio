        ...
        <div className='footer'>
            ...
            <Row className='text-center text-md-start'>
                <Col lg={4} md={6} sm={12} className='mb-3'>
                    <ListGroup>
                        <ListGroup.Item className='logo'><h4>Career Plan Today</h4></ListGroup.Item>
                        <ListGroup.Item>Lörem ipsum ir jåska, av pokanade. Reran plat är lade.  Årat sorat fingen, att divis. Nyvis podda. Trehyd. Makroktiga </ListGroup.Item>
                    </ListGroup>
                </Col>
                <Col lg={2} md={6} sm={12} className='mb-3'>
                    <ListGroup>
                        <ListGroup.Item className='footer-link-heading'><p>Quick Links</p></ListGroup.Item>
                ...
                <Col lg={2} md={6} sm={12} className='mb-3'>
                    <ListGroup>
                        <ListGroup.Item className='footer-link-heading'><p>Other Links</p></ListGroup.Item>
                        <ListGroup.Item> <a href='#'>Terms</a></ListGroup.Item>
